...
payment.PRICES_USDT.setdefault("worth_going", 0.1)
payment.PRICES_USDT.setdefault("side_event_map", 0.3)

# 工具 -> 期望原子单位（USDT 6 位小数）
_EXPECTED_AMOUNT = {"analyze_event": "500000", "worth_going": "100000", "side_event_map": "300000"}
...
if fail:
    for n, e in fail:
        ...
        traceback.print_exc()
    sys.exit(1)
print("卖方侧第 1-3 层全部通过。第 4 层（verify+settle 全链路）需买方钱包签名，见脚本顶部说明。")
